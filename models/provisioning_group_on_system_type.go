...
const (
    ...
    AZURE_DYNAMIC_UNIFIED_GROUP_PROVISIONINGGROUPONSYSTEMTYPE
    AZURE_DYNAMIC_SECURITY_GROUP_PROVISIONINGGROUPONSYSTEMTYPE
...
func (i ProvisioningGroupOnSystemType) String() string {
    return []string{"POSIX_GROUP", "GROUP_OF_NAMES", "GROUP_OF_UNIQUE_NAMES", "GROUP_GLOBAL_SECURITY", "GROUP_LOCAL_SECURITY", "GROUP_UNIVERSAL_SECURITY", "GROUP_UNKNOWN", "AZURE_ROLE", "AZURE_UNIFIED_GROUP", "AZURE_SECURITY_GROUP", "AZURE_DYNAMIC_UNIFIED_GROUP", "AZURE_DYNAMIC_SECURITY_GROUP", "SCIM", "ACCOUNT_ONLY"}[i]
}
func ParseProvisioningGroupOnSystemType(v string) (any, error) {
    ...
    switch v {
        ...
        case "AZURE_DYNAMIC_UNIFIED_GROUP":
            result = AZURE_DYNAMIC_UNIFIED_GROUP_PROVISIONINGGROUPONSYSTEMTYPE
        case "AZURE_DYNAMIC_SECURITY_GROUP":
            result = AZURE_DYNAMIC_SECURITY_GROUP_PROVISIONINGGROUPONSYSTEMTYPE
        case "SCIM":
