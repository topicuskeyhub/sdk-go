...
func (m *ServiceaccountServiceAccountLinkableWrapper) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateServiceaccountServiceAccountFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]ServiceaccountServiceAccountable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(ServiceaccountServiceAccountable)
                }
            }
            m.SetItems(res)
        }
...
func (m *ServiceaccountServiceAccountLinkableWrapper) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetItems() != nil {
...
func (m *ServiceaccountServiceAccountLinkableWrapper) SetAdditionalData(value map[string]any)() {
...
type ServiceaccountServiceAccountLinkableWrapperable interface {
    ...
    GetItems()([]ServiceaccountServiceAccountable)
    SetItems(value []ServiceaccountServiceAccountable)()
}
