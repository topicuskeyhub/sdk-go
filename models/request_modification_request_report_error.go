...
const (
    ...
    SERVICE_ACCOUNT_CANNOT_BE_REMOVED_REQUESTMODIFICATIONREQUESTREPORTERROR
    ...
    GROUP_ON_SYSTEM_CANNOT_BE_REMOVED_REQUESTMODIFICATIONREQUESTREPORTERROR
...
func ParseRequestModificationRequestReportError(v string) (any, error) {
    ...
    switch v {
        ...
        case "SERVICE_ACCOUNT_CANNOT_BE_REMOVED":
            result = SERVICE_ACCOUNT_CANNOT_BE_REMOVED_REQUESTMODIFICATIONREQUESTREPORTERROR
        ...
        case "GROUP_ON_SYSTEM_CANNOT_BE_REMOVED":
            result = GROUP_ON_SYSTEM_CANNOT_BE_REMOVED_REQUESTMODIFICATIONREQUESTREPORTERROR
