...
func (i ProvisioningProvisionedSystemType) String() string {
    return []string{"LDAP", "ACTIVE_DIRECTORY", "AZURE_TENANT", "SOURCE_LDAP_DIRECTORY", "SOURCE_AZURE_OIDC_DIRECTORY", "SOURCE_AZURE_SYNC_LDAP_DIRECTORY", "INTERNAL_LDAP", "PROVISIONED_NAMESPACE"}[i]
}
