...
// NewProvisioningRotatepwdRequestBuilderInternal instantiates a new RotatepwdRequestBuilder and sets the default values.
...
// NewProvisioningRotatepwdRequestBuilder instantiates a new RotatepwdRequestBuilder and sets the default values.
...
// Post manually rotates the user's rotating password. This is normally done once a day.
func (m *ProvisioningRotatepwdRequestBuilder) Post(ctx context.Context, requestConfiguration *ProvisioningRotatepwdRequestBuilderPostRequestConfiguration)(error) {
...
// ToPostRequestInformation manually rotates the user's rotating password. This is normally done once a day.
