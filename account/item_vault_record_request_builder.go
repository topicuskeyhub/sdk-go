...
// ById gets an item from the github.com/topicuskeyhub/sdk-go.account.item.vault.record.item collection
...
// ByIdInt64 gets an item from the github.com/topicuskeyhub/sdk-go.account.item.vault.record.item collection
