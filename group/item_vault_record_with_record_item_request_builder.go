...
import (
    ...
    i301d7e9ff90f3ad8fb75f0a9fdf04cd4fe4a3654aaaf76e70ff366938e60cc2f "github.com/topicuskeyhub/sdk-go/group/item/vault/record/item"
)

// ItemVaultRecordWithRecordItemRequestBuilder builds and executes requests for operations under \group\{groupid}\vault\record\{recordid}
...
type ItemVaultRecordWithRecordItemRequestBuilderGetQueryParameters struct {
    ...
    // Request additional information to be returned for every record.
    AdditionalAsGetAdditionalQueryParameterType []i301d7e9ff90f3ad8fb75f0a9fdf04cd4fe4a3654aaaf76e70ff366938e60cc2f.GetAdditionalQueryParameterType `uriparametername:"additional"`
}
...
type ItemVaultRecordWithRecordItemRequestBuilderPutQueryParameters struct {
    ...
    Additional []string `uriparametername:"additional"`
    // Request additional information to be returned for every record.
    AdditionalAsPutAdditionalQueryParameterType []i301d7e9ff90f3ad8fb75f0a9fdf04cd4fe4a3654aaaf76e70ff366938e60cc2f.PutAdditionalQueryParameterType `uriparametername:"additional"`
}
...
func NewItemVaultRecordWithRecordItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemVaultRecordWithRecordItemRequestBuilder) {
    m := &ItemVaultRecordWithRecordItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/group/{groupid}/vault/record/{recordid}{?additional*}", pathParameters),
    }
    return m
}
...
func (m *ItemVaultRecordWithRecordItemRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemVaultRecordWithRecordItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DELETE, "{+baseurl}/group/{groupid}/vault/record/{recordid}", m.BaseRequestBuilder.PathParameters)
