...
import (
    ...
    i6f72f7b1ff840f4bdfc3540f0174eadc1c7a96ef52f712ad1a5ec4c4cfc3c78e "github.com/topicuskeyhub/sdk-go/group/item/vault/record"
)

// ItemVaultRecordRequestBuilder builds and executes requests for operations under \group\{groupid}\vault\record
...
type ItemVaultRecordRequestBuilderGetQueryParameters struct {
    ...
    // Request additional information to be returned for every record.
    AdditionalAsGetAdditionalQueryParameterType []i6f72f7b1ff840f4bdfc3540f0174eadc1c7a96ef52f712ad1a5ec4c4cfc3c78e.GetAdditionalQueryParameterType `uriparametername:"additional"`
...
type ItemVaultRecordRequestBuilderPostQueryParameters struct {
    ...
    Additional []string `uriparametername:"additional"`
    // Request additional information to be returned for every record.
    AdditionalAsPostAdditionalQueryParameterType []i6f72f7b1ff840f4bdfc3540f0174eadc1c7a96ef52f712ad1a5ec4c4cfc3c78e.PostAdditionalQueryParameterType `uriparametername:"additional"`
}
...
// ByRecordid gets an item from the github.com/topicuskeyhub/sdk-go.group.item.vault.record.item collection
...
// ByRecordidInt64 gets an item from the github.com/topicuskeyhub/sdk-go.group.item.vault.record.item collection
// returns a *ItemVaultRecordWithRecordItemRequestBuilder when successful
...
func (m *ItemVaultRecordRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie2969523f41a2fae7d38164656da4464a9222947e5ea7fbe5cbfbbf94304e5c1.VaultVaultRecordLinkableWrapperable, requestConfiguration *ItemVaultRecordRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.POST, "{+baseurl}/group/{groupid}/vault/record{?additional*}", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
        if requestConfiguration.QueryParameters != nil {
            requestInfo.AddQueryParameters(*(requestConfiguration.QueryParameters))
        }
