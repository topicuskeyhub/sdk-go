...
// ById gets an item from the github.com/topicuskeyhub/sdk-go.group.item.vault.record.item collection
...
// ByIdInt64 gets an item from the github.com/topicuskeyhub/sdk-go.group.item.vault.record.item collection
