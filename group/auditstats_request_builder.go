...
// AuditstatsRequestBuilder builds and executes requests for operations under \group\auditstats
...
func NewAuditstatsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuditstatsRequestBuilder) {
    m := &AuditstatsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/group/auditstats", pathParameters),
    }
    return m
}
...
// Get returns the counts and statistics of groups within Topicus KeyHub.
// returns a GroupGroupsAuditStatsable when successful
// returns a ErrorReport error when the service returns a 4XX or 5XX status code
func (m *AuditstatsRequestBuilder) Get(ctx context.Context, requestConfiguration *AuditstatsRequestBuilderGetRequestConfiguration)(ie2969523f41a2fae7d38164656da4464a9222947e5ea7fbe5cbfbbf94304e5c1.GroupGroupsAuditStatsable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie2969523f41a2fae7d38164656da4464a9222947e5ea7fbe5cbfbbf94304e5c1.CreateGroupGroupsAuditStatsFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ie2969523f41a2fae7d38164656da4464a9222947e5ea7fbe5cbfbbf94304e5c1.GroupGroupsAuditStatsable), nil
}
// ToGetRequestInformation returns the counts and statistics of groups within Topicus KeyHub.
